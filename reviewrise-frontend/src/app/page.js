  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <header className="flex justify-between items-center bg-emerald-400 px-6 py-4 ">
        <div className="text-lg font-bold text-lime-50">Reviewrise</div>
      ...
      <main className="flex flex-col items-center justify-center flex-1 bg-emerald-400 text-center px-4">
        <h1 className="text-4xl font-extrabold mb-4 text-lime-50 mt-10" >Reviewrise</h1>
        <p className="text-lg font-bold  text-lime-50 mb-6">
          Obtain a comprehensive analysis of your website content, SEO insights, and actionable recommendations
        </p>
